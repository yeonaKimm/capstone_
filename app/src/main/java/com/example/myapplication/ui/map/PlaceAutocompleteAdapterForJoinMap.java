...
public class PlaceAutocompleteAdapterForJoinMap extends RecyclerView.Adapter<PlaceAutocompleteAdapterForJoinMap.PlaceViewHolder> {

    private final Context context;
    private List<AutocompletePrediction> predictionList;
    private final PlaceAutoCompleteInterface placeAutoCompleteInterface;

    public PlaceAutocompleteAdapterForJoinMap(Context context, PlaceAutoCompleteInterface placeAutoCompleteInterface) {
